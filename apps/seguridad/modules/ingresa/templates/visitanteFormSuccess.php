...
<div style="position: relative;">
    <?php
        if($visitante['persona_id']){ ?>
            ...
            <div style="position: absolute; top: 10px; left: 297px; height: 175px; width: 400px; border: solid 1px; overflow-y: auto; overflow-x: none;">
				...
				echo "<input type='hidden' name='salida' id='salida' value='0' />";
    ...
    <?php
	    ...
	    <div id="error_seguridad_persona_primer_nombre" class="error" style="display: none;">Ingrese el nombre del visitante</div>
            <label>Nombre</label>
            <div>
                ...
                <?php } else { ?>
                    <input type="text" name="seguridad_persona[primer_nombre]" id="seguridad_persona_primer_nombre" onKeyPress="return soloLetrasEspacios(event);"/>
                <?php } ?>
            </div><br/>
	    <div id="error_seguridad_persona_primer_apellido" class="error" style="display: none;">Ingrese el apellido del visitante</div>
            ...
            <div>
                ...
                <?php } else { ?>
                    <input type="text" name="seguridad_persona[primer_apellido]" id="seguridad_persona_primer_apellido" onKeyPress="return soloLetrasEspacios(event);" />
                <?php } ?>
            </div><br/>
            <label>F. Nac</label>
            <div>
