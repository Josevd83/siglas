...
<div id="contenedor">
    <div id="header" style="z-index: 1000;border:0px solid red;">
      <table width="100%" border="0" style="border:0px solid yellow">
              ...
              <td>
                  <table width="100%" border='0'>
                      <tr style="background-color: white;">
                          <td align="left">
				<?php echo image_tag('organismo/banner_central.jpg','style=height:100px;width:100%;'); ?>
		...
		<div style="position: relative; top: 0px;height:100px; left: 0px;border:BLUE solid 0px">
			<?php echo image_tag('organismo/banner_central.jpg','style=height:100px;width:100%;'); ?>
					  <!--<table width="100%">
                      <tr style="background-color: white;">
                          <td align="left">
                          ...
                          <table cellpadding="0" cellspacing="0" id="rrrr">
                              <tr>
                                  <td>
                                      ...
                                      <div id="menuidin" style="position: absolute; top: 110px; left:-196px;" onMouseover="javascript:mostrarmenu()" onmouseout="javascript:ocultarmenu()">
