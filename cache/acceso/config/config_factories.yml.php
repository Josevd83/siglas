...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/siglas/log/acceso_.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/siglas/cache/acceso//i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/siglas/apps/acceso/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/siglas/cache/acceso//template',
  'lifetime' => 86400,
  'prefix' => '/var/www/siglas/apps/acceso/template',
)));
